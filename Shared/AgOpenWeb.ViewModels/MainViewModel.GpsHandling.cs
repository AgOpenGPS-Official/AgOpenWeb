...
public partial class MainViewModel
{
    ...
    private void OnGpsDataUpdated(object? sender, AgOpenWeb.Models.GpsData data)
    {
    ...
    /// </summary>
    private void HandleGpsUiUpdates(AgOpenWeb.Models.GpsData data)
    {
    ...
    private AgOpenWeb.Models.Track.Track? _lastMirroredDisplayTrack;
    private AgOpenWeb.Models.Track.Track? _lastMirroredBaseTrack;
    private AgOpenWeb.Models.Track.Track? _lastMirroredNextTrack;
