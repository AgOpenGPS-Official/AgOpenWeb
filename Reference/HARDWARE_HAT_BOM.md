...
|---|---|---|---|---|---|---|
| U1 | 1 | TPS7B6933QDBVRQ1 | SOT-23-5 | C781801 | Ext | always-on 3.3 V from header 5 V, 15 µA. Pins: 1 IN, 2 NC, 3/4 GND, 5 OUT. Needs ≥ 2.2 µF *effective* on its output (C4 = 10 µF) |
...
| Q2 | 1 | AO3401A | SOT-23 | C15127 | **Basic** | HAT 5 V load switch, −30 V, ~50 mΩ at −4.5 V |
| Q1, Q3–Q9 | 8 | Nexperia BSS138P,215 | SOT-23 | C75547 | Ext | latch logic; Q1 = `GLOBAL_EN` hold. V<sub>th</sub> ≤ 1.5 V checked. **Don't substitute C7420339** (V<sub>th</sub> up to 1.6 V). Dual option: BSS138DW-7-F, C154900 |
...
| Ref | Qty | Part | Package | LCSC | Type | Notes |
|---|---|---|---|---|---|---|
| TV1, TV2 | 2 | SMBJ24A | SMB | C908801 | Ext | 12 V sense (J3.1) and keyed (J3.21) inputs |
...
|---|---|---|---|---|
| 1 MΩ | 3 | R11, R12, R14 | C26083 | Basic |
| 100 kΩ | 4 | R3, R5, R7, R16 | C25741 | Basic |
...
| 10 kΩ | 7 | R8, R18, R19, R31, R32, R33, R41 | C25744 | Basic |
...
40 resistors, R3–R42 (R1, R2 removed with the direct-power change).
...
48 capacitors, C3–C50 (C1, C2 removed with the direct-power change).
...
| 12 V lead: panel connector → IO board J20 | **TE 171822-4 Berg housing** + contacts at the IO board end, on J20 pin 1 (+12 V) and pins 2 + 3 (GND). **J20's pin order is the reverse of floppy-cable colours**: meter it first. Wire for ≥ 2 A (18 AWG). Optional: an inline TVS (SMBJ24A-class) across +12 V/GND at the J20 end |
| Ribbon | 26-way 1.27 mm flat cable + 2 × 2 × 13 IDC sockets, with strain relief |
| Panel connector | Deutsch/ATS-style, 26+ ways: the J3 signals (ribbon) + the 12 V/GND power pair (to J20) |
| Fuses (in the harness) | **5 A** on constant 12 V at the battery (feeds J20); **1 A** on the keyed feed (J3.21); **1 A** on the 12 V sense wire (J3.1), which can share the constant feed after the 5 A fuse |
