...
| **B6** | **Latch off-state:** key off, CM4 halted → `12V_SW` at 0 V and the IO board fully off | | open, needs the built HAT |
| **B7** | **Standby draw** with the key off, compared with the ≈ 165 µA estimate (design §4.5) | | open, needs the built HAT |
